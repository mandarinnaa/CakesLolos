...
<head>
    ...
    <title>Lolos Cake - Recuperar Contraseña</title>
...
<body>
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="card p-4">
            ...
            <img src="{{ asset('images/Log.png') }}" alt="Logo" class="img-fluid mt-3" style="max-width: 200px;">
            ...
            <div class="mt-3 text-center">
                <a href="{{ route('login') }}" class="text-white">Volver a Iniciar Sesión</a>
            </div>
        </div>
    </div>
